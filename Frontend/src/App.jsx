        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <span className="text-2xl font-bold text-indigo-600">CollegeHub</span>
            </div>
      ...
      <section className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl mb-8 max-w-2xl mx-auto">
            Connect, collaborate, and explore opportunities with your college community. From events to marketplace, we've got it all!
          </p>
          <a href="/register" className="inline-block bg-white text-indigo-600 px-6 py-3 rounded-md font-semibold hover:bg-gray-100">
            Get Started
          </a>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transform transition duration-300 hover:scale-105">
              ...
              <div className="p-6">
                ...
                <a href="/events" className="text-indigo-600 font-medium hover:underline">Learn More →</a>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transform transition duration-300 hover:scale-105">
              ...
              <div className="p-6">
                ...
                <a href="/marketplace" className="text-purple-600 font-medium hover:underline">Learn More →</a>
              </div>
            </div>
